...
export class CommandJsonNormalizer {
        ...
        if (   this._element instanceof Object
            ...
            if (   typeof this._element.command._disabled === 'string'
                ...
                currClass = 'disabled';
                    ...
                    if (    (typeof this._global_L3 === 'object')
                         && (this._global_L3.getCommandInProgress() !== '')) {
    ...
    private initCustomDialogProps() {
        // this._globalProps.callbackSource = this;
        this._globalProps.hidden = false;
        this._globalProps.title = this.getAttr('label', 'name');
        this._globalProps.text = this.getQuestionText();
        this._globalProps.controls = this.getControls();
    }
