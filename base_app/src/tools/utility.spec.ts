...
describe('UTIL', () => {
    ...
    it('TestSetup Working- and Initial- statics should have different list of property names', () => {
        const workingProps = Object.getOwnPropertyNames(TestSetup.Working_Data_Summary_Initializer.Data_Summary).join();
        const initialProps = Object.getOwnPropertyNames(TestSetup.Initial_Data_Summary_Initializer.Data_Summary).join();
