...
# cp -r /usr/src/app/simpleui-server.win/* /usr/src/app/simpleui-server && cd simpleui-server && NPM_COPY_DIST_TO_OUTPUT=false && npm run build && cd /usr/src/app/base_app && cp -r /usr/src/app/base_app.win/* /usr/src/app/base_app && NPM_COPY_DIST_TO_OUTPUT=false
